taskset -c 12-31 accelerate launch --config_file ckpts/multi_gpu.yaml src/f5_tts/train/train.py \
    ...
    ckpts.save_dir=ckpts/f5tts_vi_v1_base_ft_ali__mel_attn_0.8 \
    ckpts.resume_from_checkpoint=ckpts/f5tts_vi_v1_base_ft_ali__mel_attn_0.8/model_last.pt \
    \
    model.tokenizer=custom \
    model.tokenizer_path=ckpts/f5tts_vi_v1_base/vocab.txt \
    model.arch.mel_attn_alpha=1.0
